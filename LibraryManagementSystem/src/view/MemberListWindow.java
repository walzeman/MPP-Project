...
public class MemberListWindow extends Application {
	...
	public void start(Stage primaryStage) {
		...
		List<User> members  = loginController
				.readLibraryMember();

		table.setItems(FXCollections.observableList(members));
		TableColumn<User, String> productNameCol 
		  = new TableColumn<>(String.format("Name"));
		...
		grid.setHgap(10);
		grid.add(table, 0, 1);
		Scene scene = new Scene(grid, 640,
				480);
