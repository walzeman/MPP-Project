...
public class Start {
	...
	public static void main(String[] args) {
     //   Application.launch(CheckoutBook.class, args);
        ...
        LibraryMember lm2=new LibraryMember("Abraham","M","999999999",add,"502");
        LibraryMember lm3=new LibraryMember("Sokly","M","999999999",add1,"503");
		...
		lmHashMap.put(lm.getMemberId(), lm2);
		lmHashMap.put(lm1.getMemberId(), lm3);
		...
		//System.out.println(da.readFromStorageBook());48-56882
		
		//Book b1=da.searchBook("48-56882");
